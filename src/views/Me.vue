  ...
  <div class="me">
    <div class="headInfo">
      ...
      <div class="head-profile">
        ...
        <p class="user-id" v-else @click="headleLogin">登陆/注册</p>
        <p class="user-phone">
          <i class="fa fa-mobile"></i>
          <span v-if="userInfo">{{encryptPhone(userInfo.phone)}}</span>
          <span v-else>登陆后享有更多特权</span>
        </p>
      </div>
    ...
    <div v-if="userInfo">
      ...
      <button @click="headleLogout" class="loginOut-btn">退出登陆</button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    // 如果有用户信息就跳转myaddress没有的就跳转addAddress
    myAddress() {
